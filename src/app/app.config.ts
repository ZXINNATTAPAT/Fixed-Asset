  ...
  providers: [
    ...
    provideRouter(
      ...
      withInMemoryScrolling({
        scrollPositionRestoration: 'top', // คืนค่า Scroll Position ด้านบน
    ...
    importProvidersFrom(SidebarModule, DropdownModule),// Import SidebarModule และ DropdownModule
    IconSetService,// กำหนด IconSetService เพื่อใช้ Icon
    provideAnimations(),// เปิดใช้งาน Animation
    {
