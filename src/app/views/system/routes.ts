...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'AssetDetails2',
        loadComponent: () => import('./asset-details2/asset-details2.component').then(m => m.AssetDetails2Component),
        data: {
          title: 'AssetDetails2'
        }
      },
      {
        path: 'AssetDetails3',
        loadComponent: () => import('./asset-details3/asset-details3.component').then(m => m.AssetDetails3Component),
        data: {
          title: 'AssetDetails3'
        }
      },
